...
```{r echo=FALSE}
batters_ranked %>%
  select(Name, z_rank, z_sum, ADP, positions) -> batters_draft
...
pitchers_ranked %>%
  select(Name, z_rank, z_sum, ADP, positions) -> pitchers_draft
...
pitchers_draft %>%
  ...
  select(z_rank, Name, z_sum, round, ADP, positions) -> draft_df
