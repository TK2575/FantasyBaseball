...
### To Do
1. Validate findings, control z-scores between batters and players to make them comparable
2. visualize - adjust plotly hover over detail to include player name (or maybe just playerid?)
3. Develop tiers of players (linear model? nearest neighbor?)
